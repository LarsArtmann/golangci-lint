...
func setupOutputFormatsFlagSet(v *viper.Viper, fs *pflag.FlagSet) {
	...
	internal.AddFlagAndBind(
		...
		"output.formats.text.print-linter-name",
		true,
		printLinterNameDesc,
	)
	internal.AddFlagAndBind(
		...
		"output.formats.text.print-issued-lines",
		true,
	...
	internal.AddFlagAndBind(
		...
		"output.formats.tab.print-linter-name",
		true,
		printLinterNameDesc,
	)
	...
	internal.AddFlagAndBind(
		...
		"output.formats.checkstyle.path",
		"",
		outputPathDesc,
	)
	...
	internal.AddFlagAndBind(
		...
		"output.formats.code-climate.path",
		"",
		outputPathDesc,
	)
	...
	internal.AddFlagAndBind(
		...
		"output.formats.junit-xml.extended",
		false,
